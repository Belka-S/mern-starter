import{e as ce,Q as ge,s as X,n as we,t as I,u as lt,r as Re,f as Ct,j as b,R as Y,P as R,A as Et,i as Tt,F as jt,B as Je}from"./index-b3d4ed84.js";import{C as Ot}from"./ControlBar-d8f871f7.js";import{c as Lt,M as Rt}from"./Modal-d3e51321.js";const $t=e=>e.clusters.items,Mt=e=>e.clusters.activeItem,Ut=e=>e.clusters.filter,Bt=e=>e.clusters.isLoading,Nt=e=>e.clusters.error,ut=()=>{const e=ce($t),i=ce(Mt),s=ce(Ut),t=ce(Nt),a=ce(Bt);return{allClusters:e,activeCluster:i,filterValue:s,error:t,isLoading:a}},Pt=async()=>{if(!navigator.clipboard){ge.error("Clipboard API is unavailable");return}navigator.permissions.query({name:"clipboard-read"}).then(e=>{e.state!=="granted"&&ge.error("Browser settings > Security > Site settings > Permissions")});try{return await navigator.clipboard.readText()}catch(e){ge.error(e.message)}},It=X.ol`
...
`,Vt=({clipboardText:e,setIsModal:i})=>{var V,S,_;const s=lt(),{allClusters:t}=ut(),{register:a,handleSubmit:o,formState:{errors:c}}=cr({mode:"onBlur",resolver:dr(Lt),defaultValues:{cluster:e}}),x=v=>{s(Tt(v)),i(!1)},g=v=>{const $=`${t.length}. `.padStart(4,"0")+v;return $.length<=50?$:$.substring(0,40).concat("...")};return b.jsxs(hr,{onSubmit:o(x),children:[b.jsxs(Le,{children:[g(e)," ",b.jsx("br",{}),b.jsx("span",{children:(V=c.cluster)==null?void 0:V.message}),b.jsx(gr,{...a("cluster")})]}),b.jsxs(Le,{children:["Title: ",b.jsxs("span",{children:[" ",(S=c.title)==null?void 0:S.message]}),b.jsx(vr,{...a("title")})]}),b.jsxs(Le,{children:["Group: ",b.jsxs("span",{children:[" ",(_=c.group)==null?void 0:_.message]}),b.jsxs(pr,{children:[b.jsxs("select",{name:"pets",id:"pet-select",...a("group"),children:[b.jsx("option",{value:"common",children:"Common"}),b.jsx("option",{value:"study",children:"Study"}),b.jsx("option",{value:"work",children:"Work"})]}),b.jsx("span",{})]})]}),b.jsx(wt,{type:"submit",$size:"l",$h:"41px",children:"Submit"})]})};Vt.propTypes={clipboardText:R.string.isRequired,setIsModal:R.func.isRequired};const Ar=()=>{const[e,i]=Re.useState(!1),[s,t]=Re.useState(""),a=async()=>{t(await Pt()),s.length<10?ge.error("Coopy valid cluster"):i(!0)};return b.jsxs(jt,{$p:`${I.indent.s} ${I.indent.m}`,children:[b.jsx(Ht,{}),b.jsxs(Ot,{$x:"right",$y:"bottom",$gtc:"1fr 1fr",children:[b.jsx(Je,{$size:"m",children:"Edit"}),b.jsx(Je,{$size:"m",onClick:a,children:"Add"})]}),e&&b.jsx(Rt,{onClick:()=>i(!1),children:b.jsx(Vt,{clipboardText:s,setIsModal:i})})]})};export{Ar as default};
