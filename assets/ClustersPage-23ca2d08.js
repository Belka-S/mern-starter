import{Q as pe,m as ce,o as Ot,p as Rt,q as Mt,w as Ut,x as Pt,n as _e,s as K,t as Ae,P as L,j as m,G as Bt,u as Pe,y as Nt,r as xe,z as It,R as J,A as qt,C as zt,k as et,F as Ht}from"./index-b12c0b9d.js";import{t as Wt,M as Gt,c as Kt}from"./Modal-aa9e2a5f.js";import{C as Qt}from"./ControlBar-6545a2e4.js";const Yt=(e,s)=>Array.from(new Set(e.map(i=>i[s].toLowerCase()))),Jt=async()=>{if(!navigator.clipboard){pe.error("Clipboard API is unavailable");return}navigator.permissions.query({name:"clipboard-read"}).then(e=>{e.state!=="granted"&&pe.error("Browser settings > Security > Site settings > Permissions")});try{return await navigator.clipboard.readText()}catch(e){pe.error(e.message)}},Xt=()=>{const e=ce(Ot),s=ce(Rt),i=ce(Mt),r=ce(Ut),a=ce(Pt);return{allClusters:e,activeCluster:s,clustersFilter:i,error:r,isLoading:a}},ft=_e`
  position: absolute;
...
`,Rr=["common","study","work"],Ct=({clipboardText:e,setIsModal:s})=>{var g,w;const i=Pe(),{register:r,handleSubmit:a,formState:{errors:n}}=Cr({mode:"onBlur",resolver:Dr(Wt),defaultValues:{cluster:e}}),u=_=>{i(zt(_)),s(!1)},p=_=>_.length<=50?_:_.substring(0,40).concat("...");return m.jsxs(Tr,{onSubmit:a(u),children:[m.jsxs(Me,{children:[p(e),m.jsx(Lr,{...r("cluster")})]}),m.jsxs(Me,{children:["Title: ",m.jsxs("span",{children:[" ",(g=n.title)==null?void 0:g.message]}),m.jsx(jr,{...r("title")})]}),m.jsxs(Me,{children:["Group: ",m.jsxs("span",{children:[" ",(w=n.group)==null?void 0:w.message]}),m.jsxs(Or,{children:[m.jsx("select",{name:"pets",id:"pet-select",...r("group"),children:Rr.map(_=>m.jsx("option",{value:_,children:_},_))}),m.jsx("span",{})]})]}),m.jsx(kt,{type:"submit",$s:"l",$h:"41px",children:"Submit"})]})};Ct.propTypes={clipboardText:L.string.isRequired,setIsModal:L.func.isRequired};const Mr=()=>{const[e,s]=xe.useState(!1),[i,r]=xe.useState(""),a=async n=>{const u=await Jt();try{await Kt.validate({cluster:u}),r(u),s(!0)}catch(p){n.target.blur(),pe.error(`Invalid cluster, ${p.message}`)}};return m.jsxs(Qt,{$mi:"30px",$side:"right",$high:"bottom",$gtc:" 1fr 1fr",children:[m.jsx(et,{$s:"m",onClick:a,children:"Add"}),m.jsx(et,{$s:"m",children:"Edit"}),e&&m.jsx(Gt,{onClick:()=>s(!1),children:m.jsx(Ct,{clipboardText:i,setIsModal:s})})]})},zr=()=>{const{s:e,m:s}=Ae.indents;return m.jsxs(Ht,{$p:`2px ${s} ${e}`,children:[m.jsx(ur,{}),m.jsx(Mr,{})]})};export{zr as default};
