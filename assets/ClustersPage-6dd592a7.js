import{e as ce,Q as ge,s as X,n as we,t as I,u as lt,r as Re,f as Ct,j as b,R as Y,P as R,A as Et,i as Tt,F as jt,B as Je}from"./index-42fd413f.js";import{C as Ot}from"./ControlBar-a3940be3.js";import{c as Lt,M as Rt}from"./Modal-3dbdd385.js";const $t=e=>e.clusters.items,Mt=e=>e.clusters.activeItem,Ut=e=>e.clusters.filter,Bt=e=>e.clusters.isLoading,Nt=e=>e.clusters.error,ut=()=>{const e=ce($t),i=ce(Mt),s=ce(Ut),t=ce(Nt),a=ce(Bt);return{allClusters:e,activeCluster:i,filterValue:s,error:t,isLoading:a}},Pt=async()=>{if(!navigator.clipboard){ge.error("Clipboard API is unavailable");return}navigator.permissions.query({name:"clipboard-read"}).then(e=>{e.state!=="granted"&&ge.error("Browser settings > Security > Site settings > Permissions")});try{return await navigator.clipboard.readText()}catch(e){ge.error(e.message)}},It=X.ol`
