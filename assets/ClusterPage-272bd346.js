import{Q as pe,n as Ae,s as X,t as fe,P as T,j as b,G as Nt,u as Fe,m as It,o as ft,r as de,p as qt,q as Gt,R as Y,A as zt,S as Ht,w as Wt,k as Kt,x as Qt,y as Ze,M as Yt,F as Jt}from"./index-f796f5d9.js";import{t as Xt,g as Zt,c as er}from"./clusterSchema-356ba633.js";const tr=(e,s)=>Array.from(new Set(e.map(i=>i[s]))),rr=async()=>{if(!navigator.clipboard){pe.error("Clipboard API is unavailable");return}navigator.permissions.query({name:"clipboard-read"}).then(e=>{e.state!=="granted"&&pe.error("Browser settings > Security > Site settings > Permissions")});try{return await navigator.clipboard.readText()}catch(e){pe.error(e.message)}},ht=Ae`
  position: absolute;
