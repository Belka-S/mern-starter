...
const { GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, NODE_ENV, PORT, PROD_BACK_HTTP } = process.env;

const baseUrl = NODE_ENV === 'development' ? `http://localhost:${PORT}` : PROD_BACK_HTTP;
